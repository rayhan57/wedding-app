...
const HeroImage = () => {
  ...
  return (
    <div className="min-h-screen bg-hero-image bg-no-repeat bg-cover bg-center flex justify-center items-center flex-col text-center">
      <div className="text-5xl md:text-4xl lg:text-6xl text-white space-y-3 md:space-y-1.5 lg:space-y-3 font-custom">
        <h1>BECKHAM</h1>
        <h1>&</h1>
        <h1>DIANA</h1>
      </div>

      <p className="text-sm lg:text-base text-slate-300 tracking-[.4rem] md:tracking-[.7rem] lg:tracking-[1rem] mt-10 md:mt-5 lg:mt-10">
